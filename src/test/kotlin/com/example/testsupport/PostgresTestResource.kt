    ...
    private fun applyMigrations() {
        ...
        postgres.createConnection("").use { conn ->
            conn.createStatement().use { stmt ->
                // Wipe the schema before applying. Tests always want HEAD; this avoids
                // reinventing Atlas's revision tracking and keeps reused containers
                // (testcontainers.reuse.enable=true) safe across migration changes.
                stmt.execute(
                    """
