...
class UserWriteServiceTest {
    ...
    fun `updateUser should update all fields and return UserId`() {
        ...
        val result = userWriteService.updateUser(userId, newEmail, newUsername, newPassword, newBio, newImage)
    ...
    fun `updateUser should keep existing values when nulls provided`() {
        ...
        val result = userWriteService.updateUser(userId, null, null, null, null, null)
    ...
    fun `updateUser should throw ValidationException when email is blank`() {
        ...
        val exception =
            assertThrows<ValidationException> {
                userWriteService.updateUser(userId, "", null, null, null, null)
            }
    ...
    fun `updateUser should throw ValidationException when email has invalid format`() {
        ...
        val exception =
            assertThrows<ValidationException> {
                userWriteService.updateUser(userId, "not-an-email", null, null, null, null)
            }
    ...
    fun `updateUser should throw ValidationException when username is too short`() {
        ...
        val exception =
            assertThrows<ValidationException> {
                userWriteService.updateUser(userId, null, "ab", null, null, null)
            }
    ...
    fun `updateUser should throw ValidationException when email already taken`() {
        ...
        val exception =
            assertThrows<ValidationException> {
                userWriteService.updateUser(userId, newEmail, null, null, null, null)
            }
    ...
    fun `updateUser should throw ValidationException when username already taken`() {
        ...
        val exception =
            assertThrows<ValidationException> {
                userWriteService.updateUser(userId, null, newUsername, null, null, null)
            }
    ...
    fun `updateUser should throw ValidationException when password too short`() {
        ...
        val exception =
            assertThrows<ValidationException> {
                userWriteService.updateUser(userId, null, null, newPassword, null, null)
            }
    ...
    fun `updateUser should allow same email and username`() {
        ...
        val result = userWriteService.updateUser(userId, email, username, null, null, null)
