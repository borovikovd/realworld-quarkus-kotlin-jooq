...
class RateLimitFilter(
    ...
    private fun extractClientIp(requestContext: ContainerRequestContext): String {
        ...
        // Each trusted proxy appends the IP it received from the previous hop (left-to-right).
        // The entry just before the rightmost N proxy-controlled entries is the actual client IP.
